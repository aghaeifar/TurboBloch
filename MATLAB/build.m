...
if isunix
    flags = ' CXXFLAGS="\$CXXFLAGS -std=c++17 -D__MEASURE_ELAPSED_TIME__"';
...
elseif ispc
    ...
    flags = ' COMPFLAGS="$COMPFLAGS /std:c++17 /D__MEASURE_ELAPSED_TIME__"';
    eval(['mex -v' flags ink_dir lnk_dir1 lnk_dir2 libs src1 src2 ' -R2018a' ' -outdir ' out_path]); 
else
